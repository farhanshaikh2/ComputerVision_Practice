...
cv2.putText(image, "My Name is Farhan", (10, 30),
            cv2.FONT_HERSHEY_SIMPLEX, 0.9, colors['red'], 2, cv2.LINE_4)
cv2.putText(image, "My Name is Farhan", (10, 70),
            cv2.FONT_HERSHEY_SIMPLEX, 0.9, colors['red'], 2, cv2.LINE_8)
cv2.putText(image, "My Name is Farhan", (10, 110),
            cv2.FONT_HERSHEY_SIMPLEX, 0.9, colors['red'], 2, cv2.LINE_AA)


show_with_matplotlib(image, "blank image")
